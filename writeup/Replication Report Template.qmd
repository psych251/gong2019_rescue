...
**The key analysis of interest is the mixed design, repeated measures ANOVA of transformed AUC values controlling for demographic variables (gender, number of important family members, and number of important friends). I will be basing my decision about the success of this replication on whether there is a significant main effect of age in this ANOVA such that older adults are, across type of donation and relationship to the donation target, more generous than younger adults.**
...
```{r}
#AUC with covariates (KEY ANALYSIS OF INTEREST)
